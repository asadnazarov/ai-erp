...
import { Plus, Link2, Paperclip } from "lucide-react"
...
export default function DemoTracker() {
  ...
  const [form, setForm] = useState({
    client_name: "", type: "demo", status: "kutilmoqda", requirements: "", scheduled_at: "", deadline: "", demo_link: "", attachment_url: "",
  })
  ...
  async function addItem(e: React.FormEvent) {
    ...
    setForm({ client_name: "", type: "demo", status: "kutilmoqda", requirements: "", scheduled_at: "", deadline: "", demo_link: "", attachment_url: "" })
    setOpen(false)
    load()
  }
  ...
  return (
    <div className="space-y-6">
          ...
          <Card key={d.id}>
            <CardContent className="pt-5">
              ...
              <div className="flex gap-3">
                {d.demo_link && (
                  <a href={d.demo_link} target="_blank" rel="noreferrer" className="inline-flex items-center gap-1 text-xs text-[var(--color-accent)] hover:underline">
                    <Link2 size={11} /> Demo havolasi
                  </a>
                )}
                {d.attachment_url && (
                  <a href={d.attachment_url} target="_blank" rel="noreferrer" className="inline-flex items-center gap-1 text-xs text-[var(--color-accent)] hover:underline">
      ...
      <Dialog open={open} onOpenChange={setOpen} title="Yangi TZ / Demo so‘rovi">
